...
public class MyItem implements ClusterItem {
    ...
    private long destMainStationId;
    ...
    public long getDestMainStationId() {
        return destMainStationId;
    }
...
//        destMainStationId = destMainStId;
    ...
    public MyItem(double lat, double lng, String title, long destMainStId) {
        mPosition = new LatLng(lat, lng);
        mTitle = title;
        mSnippet = null;
        destMainStationId = destMainStId;
