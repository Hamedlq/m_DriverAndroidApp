...
import com.mibarim.driver.models.MyItem;
import com.mibarim.driver.models.Plus.SubStationModel;
import com.mibarim.driver.models.StationModel;
import com.mibarim.driver.ui.activities.StationsOnMapActivity;
...
//        myGoogleMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        /*myGoogleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                ((StationsOnMapActivity) getActivity()).setStationId(selectedId);
...
//                Toast.makeText(getActivity(),"touched",Toast.LENGTH_LONG).show();
                ((StationsOnMapActivity) getActivity()).setStationId(-1);
            }
        });
