...
import com.mibarim.driver.models.ShareResponse;
 ...
 */
public class MainActivity0 extends BootstrapActivity implements MainMapFragment.OnMainMapClickedListener {
...
/*
        Intent intent = new Intent(MainActivity0.this, SplashActivity.class);
...
/*            if (prefs.getInt("HomeWorkShown", 1) != 1) {
    ...
    private void gotoAddMapActivity() {
        //Intent intent = new Intent(MainActivity0.this, AddMainActivity.class);
        Intent intent = new Intent(MainActivity0.this, RouteStepActivity.class);
        //Intent intent = new Intent(MainActivity0.this, HomeWorkStepActivity.class);
    ...
    private void checkAuth() {
        new SafeAsyncTask<Boolean>() {
            ...
            public Boolean call() throws Exception {
                final AuthenticateService svc = serviceProvider.getService(MainActivity0.this);
                if (svc != null) {
                    authToken = serviceProvider.getAuthToken(MainActivity0.this);
                    return true;
                }
                return false;
            }
    ...
    public void onBackPressed() {
        ...
        //Toaster.showLong(MainActivity0.this, getString(R.string.press_again_to_exit), R.drawable.toast_info);
...
//        });
    ...
    /*public void deleteRoute(final String routeId) {
        new SafeAsyncTask<Boolean>() {
            ...
            protected void onSuccess(final Boolean state) throws Exception {
                super.onSuccess(state);
                new HandleApiMessages(MainActivity0.this, deleteRes).showMessages();
                getRouteRequestsFromServer();
            }
        }.execute();
    }*/
    ...
    public void shareRoute(final String routeId) {
        new SafeAsyncTask<Boolean>() {
            ...
            protected void onSuccess(final Boolean state) throws Exception {
                super.onSuccess(state);
                new HandleApiMessages(MainActivity0.this, shareRes).showMessages();
                shareRouteMsg();
            }
        }.execute();
    }
    ...
    public void getRouteInfo(final LocalRoute theRoute) {
        new SafeAsyncTask<Boolean>() {
            ...
            protected void onSuccess(final Boolean state) throws Exception {
                super.onSuccess(state);
                new HandleApiMessages(MainActivity0.this, routeInfo).showMessages();
    ...
    private void getImageFromServer(final String imageId) {
        new SafeAsyncTask<Boolean>() {
            ...
            @Override
            public Boolean call() throws Exception {
                String token = serviceProvider.getAuthToken(MainActivity0.this);
...
//                    finish();
    ...
    public void goToContactActivity(ContactModel contactModel) {
        ...
        if (contactModel.IsSupport == 1) {
            ...
            intent.putExtra("OriginActivity", "MainActivity0");
        }
    ...
    public void gotoEventActivity(EventResponse eventResponse) {
        Intent intent = new Intent(MainActivity0.this, EventMapActivity.class);
    ...
    private void insertRouteResponses(ApiResponse routeRequestApi) {
        ...
        new HandleApiMessages(MainActivity0.this, routeRequestApi).showMessages();
        refreshRouteList();
    }
    ...
    private void insertContacts(ApiResponse contactRes) {
        ...
        new HandleApiMessages(MainActivity0.this, contactRes).showMessages();
        refreshContactList();
    }
    ...
    public void gotoRideRequestActivity() {
        Intent intent = new Intent(MainActivity0.this, RideMainActivity.class);
