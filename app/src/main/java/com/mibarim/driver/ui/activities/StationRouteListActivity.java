  ...
  /*      if (getCacheDir() != null) {
    ...
    private void initScreen() {
        ...
        fragmentManager.beginTransaction()
                .add(R.id.main_container, new DriverCardFragment())
                .commit();
    }
...
//        });
    ...
    private void getImageFromServer(final String imageId) {
        new SafeAsyncTask<Boolean>() {
            ...
            @Override
            public Boolean call() throws Exception {
                String token = serviceProvider.getAuthToken(StationRouteListActivity.this);
...
//                    finish();
            ...
            protected void onSuccess(final Boolean succees) throws Exception {
                ...
                new HandleApiMessages(StationRouteListActivity.this, response).showMessages();
                //finishIt();
            }
        }.execute();
    }
